...
class TestHelperFunctions:
    ...
    @patch('src.FinalProjectApplication.fpd.getUserNames')
    ...
    @patch('src.FinalProjectApplication.fpd.getPassword')
    ...
    @patch('src.FinalProjectApplication.verifyUserCred')
    @patch('src.FinalProjectApplication.Load_Frame_Home')
    @patch('src.FinalProjectApplication.fpd.getUserID')
    ...
    @patch('src.FinalProjectApplication.verifyUniqeUser')
    @patch('src.FinalProjectApplication.fpd.new_user')
    @patch('src.FinalProjectApplication.Load_Frame_Home')
    @patch('src.FinalProjectApplication.fpd.getUserID')
    ...
    @patch('src.FinalProjectApplication.fpd.new_plant')
    @patch('src.FinalProjectApplication.load_user_plants_widgets')
    ...
    @patch('src.FinalProjectApplication.fpd.remove_plant')
    @patch('src.FinalProjectApplication.load_user_plants_widgets')
    ...
    @patch('src.FinalProjectApplication.fpd.getUserPlants')
    @patch('src.FinalProjectApplication.fpd.getPlantNames')
    @patch('src.FinalProjectApplication.fpd.getPlantInfo')
    @patch('src.FinalProjectApplication.tk.IntVar')
    @patch('src.FinalProjectApplication.tk.Radiobutton')
    @patch('src.FinalProjectApplication.tk.Label')
    @patch('src.FinalProjectApplication.tk.Text')
    @patch('src.FinalProjectApplication.tk.Button')
    ...
    @patch('src.FinalProjectApplication.fpd.getWatLog')
    @patch('src.FinalProjectApplication.tk.Label')
    @patch('src.FinalProjectApplication.tk.Button')
    @patch('src.FinalProjectApplication.tk.Listbox')
